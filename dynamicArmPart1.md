## Dynamic ARM Templates Using YML and Object Parameters

The ARM templates I was having to manage were starting to get out of control. They are chalked full of hard-to-read parameters and inconsistencies. The original intent of the ARM deployments was to have 1 ARM template to house all the resources that needed to be built in 1 repository, along with 1 parameters file to house all of the ARM parameters along with any build parameters needed. The downside of this is that the cluster of parameters mixed in with layers of resources can make viewing and managing the ARM template and parameters file pretty nasty.
...
So now that I have a more manageable process for defining my parameters, I can start to look at how to manage my resource within my ARM templates. [Part 2 coming soon...](https://github.com/TerrapinStation/blog/dynamicArmPart2.md)